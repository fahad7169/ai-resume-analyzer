...
export default function Auth() {
  ...
  return (
    <main className="bg-[#0F172A] min-h-screen flex flex-col without-navbar">
      {/* Header */}
      ...
      <div className="auth-container">
        <div className="auth-content">
          ...
          <div className="auth-hero">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Welcome to ResumeX</h1>
            <p className="text-[#94A3B8] text-base sm:text-lg">Get AI-powered feedback to land your dream job</p>
          </div>
          ...
          <div className="auth-card">
            ...
            {auth.isAuthenticated ? (
              <div className="text-center">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">You're signed in!</h2>
                <p className="text-sm sm:text-base text-[#94A3B8] mb-4 sm:mb-6">Ready to analyze your resume?</p>
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <button 
                    ...
                    className="w-full text-[#94A3B8] py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg font-medium hover:text-white hover:bg-[#334155] transition-all text-sm sm:text-base"
                  >
                    Sign Out
                  </button>
                </div>
              ...
              <div>
                <div className="text-center mb-4 sm:mb-6">
                  ...
                  <p className="text-sm sm:text-base text-[#94A3B8]">Access your resume analysis dashboard</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="bg-[#1E293B] px-4 text-[#64748B]">Secure & Private</span>
                    </div>
                  </div>
          ...
          <div className="text-center mt-6">
            <Link to="/" className="text-[#64748B] hover:text-[#94A3B8] transition-colors text-sm inline-flex items-center gap-2">
